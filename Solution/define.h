...
const unsigned long long FLOG_GREEN			= 0x0000000000000080;	//ガマ(緑)
...
const unsigned long long FLOG_RED			= 0x0000020000000000;	//ガマ(赤)
...
enum GRAPH {
	...
	GRAPH_ENEMY_ROCK_SHELL,
	GRAPH_ENEMY_ROCK_ITEM,
	GRAPH_BG,
	GRAPH_BG_1,
	GRAPH_BG_2,
	GRAPH_BG_3,
